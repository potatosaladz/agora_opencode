...
Phase 14 contract `[x]`; implementation tasks are T14-01 Graph View `[ ]`, T14-02 Dissent View `[ ]`,
...
[../docs/PHASE14_ACCEPTANCE.md](../docs/PHASE14_ACCEPTANCE.md). T14-01 is next; do not start it
automatically.
