...
T14-03 Assumption Register `[x]`, T14-04 Explanation Panel `[x]`, T14-05 Replay Controls `[ ]`, and
T14-06 Audit Search `[ ]`. Exact boundaries and the unpassed scripted usability fixture are frozen in
[../docs/PHASE14_ACCEPTANCE.md](../docs/PHASE14_ACCEPTANCE.md). T14-05 is next; do not start it
automatically.
